...
루틴이 지연 실행되면 폴백(17:11/17:51/18:31 KST 시도)이 먼저 발행한 뒤 루틴이 또 발행하는 이중 발행이 생긴다
...
8건 이상 수집 → 하드 게이트 → 점수 평가 → 2건 확정.
**선별 기준은 '사건성 + 인지도'** — 오늘 문화예술계에 실제로 벌어진 일인가,
그 고유명사를 대중이 아는가. 카테고리 다양성은 강제하지 않는다 (curation.md 참고).
