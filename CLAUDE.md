...
| 우선순위 | 소스 | 비고 |
|---------|------|------|
| 1 | https://arthub.co.kr/sub06/board01_list.htm?Sub_No=2&page=1&key_type= | 전문 아트 매체, 최우선 확인 |
| 2 | WebSearch: `문화예술 뉴스 오늘`, `전시 공연 소식 오늘` | 최신 보도 보완 |
| 3 | WebSearch: `미술관 박물관 전시 개막` | 추가 후보 보완 |

### 후보 선별 기준 (우선순위 순)
1. **최신성** — 오늘~이번 주 개막/발표 우선
2. **화제성·유행** — SNS 반응 많은 것, 트렌딩 아티스트·장소
3. **인지도** — 국내외 유명 기관/작가, 대중 관심도 높은 주제
4. **시각적 완성도** — 이미지 출처가 확정/유력한 것 우선
