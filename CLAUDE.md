...
검색 시 **반드시 구체적 날짜(MM월 DD일)를 쿼리에 포함**해 최신 기사를 우선 수집한다.  
검색 전 `output/news/*.json` 최근 14일 파일을 읽어 이미 사용한 `news_url`·이벤트명을 블랙리스트로 만든 후 중복 제외한다.

### 카테고리별 검색 키워드

| 카테고리 | 검색 키워드 예시 | 우선순위 |
|----------|----------------|---------|
| **전시·개막** | `전시 개막 MM월 DD일 2026`, `아트페어 개막 이번주 2026` | ★★★ |
| **K-콘텐츠 제작·출시** | `드라마 제작 발표 예술 2026 MM월`, `영화 미술 문학 원작 제작확정` | ★★★ |
| **국제 아트·테크 이슈** | `AI 미술관 갤러리 2026`, `해외 아트씬 화제 이번주` | ★★★ |
| **SNS·플랫폼 유행** | `AI 그림 유행 챌린지 2026`, `인스타 아트 트렌드 이번주` | ★★★ |
| **화제성·트렌드** | `미술관 전시 화제 인기 2026 MM월` | ★★ |
| **아트씬 전문** | `site:design.co.kr 2026`, `site:eyesmag.com 2026`, `site:careet.net 2026` | ★★ |
| **전문 아트 매체** | https://arthub.co.kr/sub06/board01_list.htm?Sub_No=2&page=1&key_type= | ★ |
...
**콘텐츠 유형은 전시 개막에 한정하지 않는다.** 아래 유형을 골고루 섞어 3건을 구성한다:

#### 허용 콘텐츠 유형 (모두 동등 우선순위 ★★★)

- **전시·개막·아트페어** — 미술관 전시 오픈, 갤러리 기획전, 아트페어 개막
- **K-콘텐츠 제작·출시** — 드라마·영화·웹툰 중 예술·문학 원작 제작 발표, 주목할 만한 크리에이티브 프로젝트
- **국제 아트·테크 이슈** — 해외 AI 미술관 개관, 글로벌 아트씬 패러다임 변화, 국내 연결고리 있는 해외 이슈
- **SNS·플랫폼 유행·밈** — AI 드로잉 챌린지, 아트 스타일 트렌드, 인스타/틱톡 아트 밈, 크리에이터 이슈

#### 선정 점수 기준 (내림차순)

1. **신선도** — 14일 이내 기사 허용. 오늘·어제 기사에 가점, 오래될수록 감점. 15일 이상은 제외
2. **미사용** — 최근 14일 내 `output/news/*.json`에 없는 이벤트·URL
3. **타이밍 임팩트** — "지금 이 주에 봐야 하는 이유"가 명확한 것
4. **화제성·유행** — SNS 실제 반응, 트렌딩 작가·공간·이벤트, 팝컬처 접점 가점
5. **시각적 임팩트** — 썸네일 한 장으로 멈춰서게 할 수 있는 이미지
6. **인지도·스케일** — 유명 기관/작가, 대중 접근성 높은 주제
7. **아트씬 의미** — "이게 왜 중요한가" 설명 가능한 것
